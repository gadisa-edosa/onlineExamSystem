            ...
            @if (count($attempts) > 0)
                ...
                @foreach ($attempts as $attempt)
                    <tr>
                        ...
                        <td>
                            @if ($attempt->status == 0)
                                <a href="#" data-toggle="modal" data-target="#reviewExamModel" class="reviewExam"
                                    data-id="{{ $attempt->id }}">Review & Approved</a>
                            @else
                                Completed
                            @endif
                        </td>
                    ...
                    success: function(data) {
                        ...
                        if (data.success == true) {
                            ...
                            if (data.length > 0) {
                                ...
                                html +=
                                    '<h6>student not attempt any Question!<h6> <p>if you approve this exam student will faill!</p>';
